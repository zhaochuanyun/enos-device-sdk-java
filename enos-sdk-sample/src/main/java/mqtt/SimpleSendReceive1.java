...
public class SimpleSendReceive1 {
    ...
    static void postMeasurepoint() throws EnvisionException {
        ...
        MeasurepointPostRequest request = MeasurepointPostRequest.builder()
                ...
                .addMeasurePoint("m1", new Random().nextInt(100))
                .build();
